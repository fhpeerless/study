...
const chineseNotes = [
  {
    title: "初识html可视化编程！",
    content: "<br>html可视化编程可以下载<a href="https://www.jetbrains.com/webstorm/">webstorm</a>  <br>或者更简单的方式实现可视化， <br>新建一个txt文本把h5代码复制进去，<br>然后格式改成html即可！",
    timestamp: "2025-10-17 08:30",
    image: "https://example.com/images/poetry.jpg" // 示例图片URL
  },
  {
    title: "文言文翻译技巧",
    content: "文言文翻译需注意三点：一是理解上下文，二是掌握常见虚词（如之、乎、者、也）的用法，三是注意古今异义词。例如'之'在句中常作助词或代词，需根据语境判断。",
