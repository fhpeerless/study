...
title: "图像热区超链接",
    content: [" <h3>热区链接的代码官方表示：</h3> ",
        ...
        "当点击图片上的特定坐标位置的时候，可以链接到其他页面！，图像热区区域可以通过ps来获取坐标，ps中的点击窗口，信息即可显示坐标，坐标要以像素来编写，",
         " <h4>热区链接所要注意：</h4> 热区区域是根据坐标来确定的，但是区域是根据代码来计算的，如果整个图片没有加入auto属性就是固定图片大小<br>那么图片的大小被固定，热区域也会随之固定，当用户拖动窗口，热区域不变，图片区域不变，就会导致图片位置与图片区域对不上，<br>相反加入auto，那么图片大小是发生变动的，浏览器收到图片大小会发生变动的信息，热区域也会随之变动，自适应！",     
        " <h3> 热区链接的写法: </h3>",
        ...
        "<img src=\"http://note.youdao.com/yws/api/personal/file/WEB394a8751d960b9357073a7b487b0be75?method=download&inline=true&shareKey=2db1f60696f2c1755197670991d1be1b\" useMap=\"#123map\" alt=\"shenyue_zhao\" style=\"width: auto; height: auto;\"/> ",
