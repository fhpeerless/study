...
export const note1 = {
    ...
    content: [   /* 在JSON中，字符串内部的双引号必须用反斜杠转义，即\"。以下是修正后的JSON： */
        ...
        "<br> <h3>图像的间距vspace(是图像对于上下方的文字间距)和(hspace是图像对于文字左右方向的间距) </h3>  &lt;img src=\"dancer.png\" alt=\"图片未加载成功的提示\" width=\"10%\" height=\"10%\" hspace=\"30\" vspace=\"30\" title=\"鼠标悬停到图片所提示的字符\"/&gt " ,
