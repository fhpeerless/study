...
export const note3 = {
    ...
    content: [   /* 123123*/
        ...
        "<h3>选择带有class属性的标签</h3>class选择器选择带有class属性值的标签，并加入css样式，此代码找到class为nimei的值后，更改了p标签的背景颜色<br> &lt;P class=\"nimei\"&gt;测试属性选择器&lt;/P&gt; &lt;style&gt; .nimei{background-color: aquamarine}&lt;/style&gt;  <br> <h4>代码运行展示</h4> <br>  <style> .nimei{background-color: aquamarine}</style> <P class=\"nimei\">测试属性选择器</P>",
        "<h3>选择并设置所有 target=\"_blank\" 的 a 元素的样式，</h3>带有target且值等于blank的a元素会被设置黄色背景 <br>  &lt;h3&gt;代码运行展示&lt;/h3&gt; &lt;style&gt;a[target=\"_blank\"]{background-color: yellow;} &lt;/style&gt; <br>  &lt;a href=\"https://www.w3school.com.cn\"&gt;W3School&lt;/a&gt;  <br> &lt;a href=\"https://www.google.com\" target=\"_blank\"&gt;Google&lt;/a&gt; <br>  ",
