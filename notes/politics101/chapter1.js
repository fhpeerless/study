...
export const note1 = {
   title: "主要考查科目以及真题讲解",
   content: 
"马克思主义基本原理概论（马原）: 考试中占有重要比重，通常是难点和易失分点。<br> " +
"毛泽东思想和中国特色社会主义理论体系概论（毛中特）: 被认为是重中之重，在考试中占比也很大。<br> " +
"中国近现代史纲要（史纲）: 考察中国近现代历史的变迁和发展。  <br>" +
"思想道德修养与法律基础（思修）: 考察思想道德和法律方面的知识。 <br>" +
"形势与政策以及当代世界经济与政治（形势与政策/当代）: 考察当前的国内外形势和政策！<br>--><a href=\"https://baidu.com/\">badu</a><----",
